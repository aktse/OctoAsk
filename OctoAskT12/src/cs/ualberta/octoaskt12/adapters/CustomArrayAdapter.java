...
public class CustomArrayAdapter extends ArrayAdapter<Question> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView answers = (TextView) view
				.findViewById(R.id.list_question_answer);
		answers.setText(questions.get(position).getAnswers().size()
				+ " answers");
		...
		TextView upvotes = (TextView) view
				.findViewById(R.id.list_question_upvote_caption);
